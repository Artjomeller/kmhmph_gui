...
public class MyListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        //  System.out.println("Keegi klikkis nuppu :)"); System.out.println(view.getCmbTimes().getSelectedItem());
        int counter = Integer.parseInt(Objects.requireNonNull(view.getCmbTimes().getSelectedItem()).toString());
